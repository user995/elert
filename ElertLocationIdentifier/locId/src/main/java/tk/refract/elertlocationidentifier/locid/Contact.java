...
public class Contact {
    ...
    public Contact(Context context, String cell) {
        ...
        Cursor phones = context.getContentResolver().query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, null, ContactsContract.CommonDataKinds.Phone.NUMBER + " LIKE '%" + temp+"'", null, null);
        phones.moveToFirst();
